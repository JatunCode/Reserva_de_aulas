<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        <form action="{{ route('solicitud.store') }}" method="POST" class="row g-3" id="solicitudForm">
            ...
            <div class="col-md-6">
                <label for="modo" class="form-label">Materia2:</label>
                <select class="form-select" id="materia" required name="materia">
            ...
            <div class="col-6">
                <label for="grupo" class="form-label">Grupo(sa):</label>
